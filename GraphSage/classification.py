...
if __name__ == "__main__":
    ...
    # the GraphSage node list is smaller than the raw node list because some illegal nodes are filtered
    graphsage_node_file = str(output_folder) + "/node_list"
    print(graphsage_node_file)
