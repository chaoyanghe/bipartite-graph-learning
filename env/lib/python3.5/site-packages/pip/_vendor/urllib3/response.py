...
class HTTPResponse(io.IOBase):
    ...
    def _decode(self, data, decode_content, flush_decoder):
        """
        Decode the data passed in and potentially flush the mlp.
        """
        try:
    ...
    def _flush_decoder(self):
        """
        Flushes the mlp. Should only be called if the mlp is actually
        being used.
        """
        if self._decoder:
    ...
    def read_chunked(self, amt=None, decode_content=None):
        ...
        with self._error_catcher():
            ...
            if decode_content:
                ...
                # mlp. However, on Jython we *might* need to, so
