...
if __name__ == "__main__":
    ...
    hpo_batch_size = [100, 300, 800]  # 3
    hpo_epochs = [5, 6, 7]  # 3
    hpo_lr = [0.0001, 0.001]  # 2
    hpo_weight_decay = [0.01, 0.001]  # 2
    hpo_dis_hidden = [8, 32, 48]  # 3 input - gcn_output, output: ~15
    hpo_dropout = [0.25, 0.5, 0.55]  # 3
    hpo_gcn_output = [8, 32, 64]  # 3
    ...
    print("start lr_cmd")
    lr_cmd = "/mnt/shared/etc/anaconda3/bin/python3 /mnt/shared/home/bipartite-graph-learning/HGCN/binary_classification.py " \
             "--rank %s" % rank
    os.system(lr_cmd)
    print("end lr_cmd")
