...
if __name__=="__main__":
    ...
    print("This is the demo for logistic regression using the embedding vectors")
    # Performing example logistic regression 
    if os.path.exists(emb_file):
        max_iter = 300
        lr_cmd = "python logistic_regression.py --verbose 0 --input_folder %s --emb_file %s --res_file %s --max_iter %d"%(input_folder, emb_file, res_file, it)
